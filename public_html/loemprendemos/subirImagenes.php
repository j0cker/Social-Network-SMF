...
if($_GET["url"]){
  ...
  if(strtoupper(substr($local,-4))==strtoupper(".jpg") || strtoupper(substr($local,-4))==strtoupper(".gif") || strtoupper(substr($local,-4))==strtoupper(".png")){
    $subir=2;
  }
  if(strtoupper(substr($local,-5))==strtoupper(".jpeg")){
    $subir=2;
  }
} else if($_POST["base"]){
