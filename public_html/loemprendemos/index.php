...
function smf_main()
{
	...
	if (empty($_REQUEST['action']) || !in_array($_REQUEST['action'], array('dlattach', 'enotify', 'findmember', 'jseditor', 'jsoption', 'requestmembers', 'smstats', '.xml', 'xmlhttp', 'verificationcode', 'viewquery', 'viewsmfile')))
	{
	...
	$actionArray = array(
		...
		'restoretopic' => array('RemoveTopic.php', 'RestoreTopic'),
                'project' => array('Project.php', 'Project'),
