...
CKEDITOR.config.smiley_images = [
	'regular_smile.png', 'sad_smile.png', 'wink_smile.png', 'teeth_smile.png', 'confused_smile.png', 'tongue_smile.png',
        'embarrassed_smile.png', 'omg_smile.png', 'whatchutalkingabout_smile.png', 'angry_smile.png', 'angel_smile.png', 'shades_smile.png',
	'devil_smile.png', 'cry_smile.png', 
        'wink.gif','cheesy.gif','grin.gif','angry.gif', 'sad.gif', 'shocked.gif', 'cool.gif', 'huh.gif', 'rolleyes.gif', 'tongue.gif',
        'embarrassed.gif', 'lipsrsealed.gif', 'undecided.gif', 'kiss.gif', 'cry.gif', 'angel.png', 'smiley.gif', '+1.gif',
        'angry2.gif', 'baaa.gif', 'bandit.png', 'beer.png', 'bigeyes.png', 'biker.gif',
        'lightbulb.png', 'thumbs_down.png', 'thumbs_up.png', 'heart.png', 'broken_heart.png', 'kiss.png', 'envelope.png'
];

CKEDITOR.config.smiley_descriptions = [
	'smiley', 'sad', 'wink', 'laugh', 'frown', 'cheeky', 
        'blush', 'surprise', 'indecision', 'angry', 'angel', 'cool', 
        'devil', 'crying',
        'wink2','chessy', 'sonreir','enojado', 'triste', 'shocked', 'cool', 'huh', 'rolleyes', 'tongue', 
        'embarrassed', 'lipsrsealed', 'undecided', 'kiss2', 'cry', 'angel2', 'smiley2', 'bandera',
        'angry2', 'baaa', 'bandit', 'beer', 'bigeyes', 'biker',
