			...
			CKEDITOR.dialog.add('youtube', function (instance) {
				...
				return {
					...
					onLoad: function(){
						...
						var youtubePlugin = $("[name='youtubePlugin']");
						console.log(youtubePlugin);
						youtubePlugin["0"].parentNode.children["0"].children["0"].children["0"].children[3].style.display = "none";
						youtubePlugin["0"].parentNode.children["0"].children["0"].children["0"].children[4].style.display = "none";
						youtubePlugin["0"].parentNode.children["0"].children["0"].children["0"].children[5].style.display = "none";
						youtubePlugin["0"].parentNode.children["0"].children["0"].children["0"].children[6].style.display = "none";
					
						youtubePlugin["0"].children["0"].children["0"].children[2].children["0"].children["0"].children["0"].children["0"].children["0"].id = "urlYoutube";
						youtubePlugin["0"].children["0"].children["0"].children[2].children["0"].children["0"].children["0"].children["0"].children["1"].id = "urlYoutubeWidth";
						youtubePlugin["0"].children["0"].children["0"].children[2].children["0"].children["0"].children["0"].children["0"].children["2"].id = "urlYoutubeHeight";
					
					    
					
						$("#urlYoutube").addClass("col-md-12");
						$("#urlYoutube").attr("style","");
						
						var attrs = { };

						$.each($("#urlYoutube")[0].attributes, function(idx, attr) {
							attrs[attr.nodeName] = attr.nodeValue;
						});
						
						$("#urlYoutube").replaceWith(function () {
							return $("<div>", attrs).append($(this).contents());
						});
						
						
						$("#urlYoutubeWidth").addClass("col-md-6");
						$("#urlYoutubeWidth").attr("style","");
						
						var attrs = { };

						$.each($("#urlYoutubeWidth")[0].attributes, function(idx, attr) {
							attrs[attr.nodeName] = attr.nodeValue;
						});
						
						$("#urlYoutubeWidth").replaceWith(function () {
							return $("<div>", attrs).append($(this).contents());
						});
						$("#urlYoutubeHeight").addClass("col-md-6");
						$("#urlYoutubeHeight").attr("style","");
						
						var attrs = { };

						$.each($("#urlYoutubeHeight")[0].attributes, function(idx, attr) {
							attrs[attr.nodeName] = attr.nodeValue;
						});
						
						$("#urlYoutubeHeight").replaceWith(function () {
							return $("<div>", attrs).append($(this).contents());
						});
						
						$("#urlYoutubeWidth").wrap("<div id='padreUrlYoutubeSize' class='col-md-12'></div>");
						
						$("#urlYoutubeHeight").wrap("<p id='wrapYoutube'></p>");

						$("#padreUrlYoutubeSize").append($("#urlYoutubeHeight").parent().html());
