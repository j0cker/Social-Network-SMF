...
( function() {
	...
	var smileyMap = { smiley: ':/', sad: ':K', wink: ':A', laugh: ':B', frown: ':C', cheeky: ':E', 
blush: ':*)', surprise: ':-o', indecision: ':|', angry: ':F', angel: 'o:)', cool: '8-)', 
devil: '>:-)', crying: ';(', shocked: ':o',
wink2: ';)', chessy: ':D', sonreir: ';D', enojado: '>:(', triste: ':(', cool : '8)', huh: '[???]', rolleyes: '::)', tongue: ':P', embarrassed: '[:-]', lipsrsealed : ':-X', undecided: '[:-K]', kiss2: ':-*', cry: '[:(]', angel2: ':o0', smiley2: ':)', bandera: '[+1]',
angry2: '[:G]', baaa: '[:H]', bandit: '[:I]', beer: '[:J]', bigeyes: '[:L]', biker: '[:M]',
kiss: ':-*' },
