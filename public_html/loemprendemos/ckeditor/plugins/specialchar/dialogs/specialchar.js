	...
	return {
		...
		onLoad: function() {
			...
			var html = [ '<table role="listbox" aria-labelledby="' + charsTableLabel + '"' +
				' style="width: 320px; border-collapse: separate;"' +
			...
			$(".cke_dialog_contents_body").wrap("<div></div>");
			$(".cke_dialog_contents_body").parent().css("height","300");
			$(".cke_dialog_contents_body").parent().css("overflow-y","scroll");
			$(".cke_dialog_contents_body").css("height","300");
			//$(".cke_dialog_ui_hbox_last").addClass("hidden-xs");
 
                       var imagePlugin = $(".cke_dialog_contents_body");
			console.log(imagePlugin);
			imagePlugin[imagePlugin.length-1].children["0"].children["0"].children["0"].children["0"].children["0"].children["0"].children["0"].children["0"].children[1].className += " hidden-xs"
