...
$txt['forum_index'] = 'Conecta y Comparte con Emprendedores - Loemprendemos';
...
$txt['on'] = 'en';
$txt['remove'] = 'Eliminar';
$txt['start_new_topic'] = 'Crear nuevo Tema o Post';

$txt['register'] = 'Crea una Cuenta';
$txt['login2'] = 'Crea una Cuenta';
$txt['login'] = 'Ingresar';
// Use numeric entities in the below string.
$txt['username'] = 'Nombre';
$txt['password'] = 'Contraseña';

$txt['username_no_exist'] = 'Correo Electrónico no existente.';
...
$txt['members_online_stats_index'] = 'Miembro(s) y';
$txt['guests_online_stats_index'] = 'Visitante(s) en línea';
$txt['members_stats_index'] = 'Total de Miembros: ';
$txt['posts_stats_index'] = 'Total de Temas y Comentarios: ';
$txt['benvenida_stats_index'] = 'Bienvenida al último usuario registrado';
...
$txt['location'] = 'Ubicación (País, Ciudad)';
$txt['gender'] = 'Sexo';
...
$txt['error_invalid_characters_username'] = 'Carácter inválido en el correo electrónico.';

$txt['welcome_guest'] = 'Bienvenido(a), <strong>%1$s</strong>. Por favor, <a href="' . $scripturl . '?action=login">ingresa</a> o <a href="' . $scripturl . '?action=register">Crea una Cuenta</a>.';
$txt['login_or_register'] = 'Por favor <a href="' . $scripturl . '?action=login">ingresa</a> o <a href="' . $scripturl . '?action=register">Crea una Cuenta</a>.';
...
$txt['always_logged_in'] = 'Recordar siempre Correo Electrónico y Contraseña';
...
$txt['forum_stats'] = 'Más Información';
...
$txt['geek'] = 'un montón';
$txt['info_center_title'] = 'Centro de Información';
...
$txt['allow_user_email2'] = '(No se mostrará)';
...
$txt['one_month'] = '1 Mes';
$txt['forever'] = 'Siempre';
$txt['quick_login_dec'] = 'Ingresar con Correo Electrónico, contraseña y duración de la sesión';
$txt['one_hour'] = '1 Hora';
$txt['moved'] = 'MOVIDO';
...
$txt['new_topic'] = 'Crear Nuevo Tema o Post';
...
$txt['find_username'] = 'Nombre, o dirección de email';
...
$txt['temas_mensajes_recientes'] = 'Tema: ';
$txt['por_mensajes_recientes'] = 'por: ';
...
$txt['Project_Head'] = "Crea Nuevo Proyecto/Startup";
$txt['Project_PageTitle'] = "Crea Nuevo Proyecto/Startup";
$txt['Project'] = "Crea Nuevo Proyecto/Startup";


$txt['ProjectsList_Head'] = "Lista de Proyectos/Startups";
$txt['ProjectsList_PageTitle'] = "Lista de Proyectos/Startups";
$txt['ProjectsList'] = "Lista de Proyectos/Startups";

$txt['ProjectsListMod'] = "Modificar Proyecto";


//select lookingFor
$txt['lookingFor'][0] = "Socios/Fundadores";
$txt['lookingFor'][1] = "Inversión";
$txt['lookingFor'][2] = "Mentores";
$txt['lookingFor'][3] = "Talleres/Incubadora/Aceleradora";
$txt['lookingFor'][4] = "Proveedores";
$txt['lookingFor'][5] = "Otro";

//select category
$txt['category'][0] = "Arte/Artesanías/Teatro";
$txt['category'][1] = "Música";
$txt['category'][2] = "Juegos";
$txt['category'][3] = "Fotografía";
$txt['category'][4] = "Tecnología";
$txt['category'][5] = "Marketing";
$txt['category'][6] = "Diseño";
$txt['category'][7] = "Negocios";
$txt['category'][8] = "Social";
$txt['category'][9] = "Medicina";
$txt['category'][10] = "Otro";

//select employees
$txt['employees'][0] = "0-10";
$txt['employees'][1] = "10-100";
$txt['employees'][2] = "100-500";
$txt['employees'][3] = "500-1K";
$txt['employees'][4] = "1k-5k";
$txt['employees'][5] = "5k-10k";
$txt['employees'][6] = "10k+";

$txt['select_default_value'] = "selecciona";

//tipo de perfil

$txt['tipo_profesion'][0] = "Emprendedor";
$txt['tipo_profesion'][1] = "Taller/Incubadora/Aceleradora";
$txt['tipo_profesion'][2] = "Inversionista";
$txt['tipo_profesion'][3] = "Proveedor";
$txt['tipo_profesion'][4] = "Mentor";
$txt['tipo_profesion'][5] = "Otro";

//tipo de perfil emprendedor
$txt['tipo_profesion_emprendedor'][0] = "Programador(a)";
$txt['tipo_profesion_emprendedor'][1] = "Diseñador(a)";
$txt['tipo_profesion_emprendedor'][2] = "Mercadólogo/Mercadóloga";
$txt['tipo_profesion_emprendedor'][3] = "Vendedor(a)/Hustler/Salesman";
$txt['tipo_profesion_emprendedor'][4] = "Industrial";
$txt['tipo_profesion_emprendedor'][5] = "Infraestructura/Redes";
$txt['tipo_profesion_emprendedor'][6] = "Mecánico/Mecánica";
$txt['tipo_profesion_emprendedor'][7] = "Economista";
$txt['tipo_profesion_emprendedor'][8] = "Contador";
$txt['tipo_profesion_emprendedor'][9] = "Negocios";
$txt['tipo_profesion_emprendedor'][10] = "Matemático/Matemática";
$txt['tipo_profesion_emprendedor'][11] = "Abogado/Abogada";
$txt['tipo_profesion_emprendedor'][12] = "Periodista";
$txt['tipo_profesion_emprendedor'][13] = "Escritor/Escritora";
$txt['tipo_profesion_emprendedor'][14] = "Psicólogo/Psicóloga";
$txt['tipo_profesion_emprendedor'][15] = "Educador/Educadora";
$txt['tipo_profesion_emprendedor'][16] = "Doctor/Doctora";
$txt['tipo_profesion_emprendedor'][17] = "Veterinario/Veterinaria";
$txt['tipo_profesion_emprendedor'][18] = "Biólogo/Bióloga";
$txt['tipo_profesion_emprendedor'][19] = "Químico/Química";
$txt['tipo_profesion_emprendedor'][20] = "Cocinero/Cocinera";
$txt['tipo_profesion_emprendedor'][21] = "Restaurantero/Restaurantera";
$txt['tipo_profesion_emprendedor'][22] = "Actor/Actriz";
$txt['tipo_profesion_emprendedor'][23] = "Músico/Música";
$txt['tipo_profesion_emprendedor'][24] = "Crominólogo/Criminóloga";
$txt['tipo_profesion_emprendedor'][25] = "Historiador/Historiadora";
$txt['tipo_profesion_emprendedor'][26] = "Político/Política";
$txt['tipo_profesion_emprendedor'][27] = "Sociólogo/Socióloga";
$txt['tipo_profesion_emprendedor'][28] = "Otro";

//busca perfil
$txt['busca_profesion'][0] = "Emprendedores";
$txt['busca_profesion'][1] = "Talleres/Incubadoras/Aceleradoras";
$txt['busca_profesion'][2] = "Inversionistas";
$txt['busca_profesion'][3] = "Proveedores";
$txt['busca_profesion'][4] = "Mentores";
$txt['busca_profesion'][5] = "Otros";

//email conecta solicitud
$txt['solicitud_conexion_subject'] = "Loemprendemos: Nueva Solicitud de Conexion";
$txt['solicitud_conexion1'] = "El usuario";
$txt['solicitud_conexion2'] = "está interesado en tu perfil y te ha mandado una solicitud de conexión en Loemprendemos. Para poder aceptar ésta solicitud, favor de dar click en el siguiente enlace:";
$txt['solicitud_conexion3'] = "o visita su perfil a través de la siguiente liga:";
$txt['solicitud_conexion4'] = "Cualquier duda o sugerencia que tenga, puede responder a éste mensaje y el staff de Loemprendemos lo atenderá.";
$txt['solicitud_conexion5'] = "Saludos,\nEl equipo de ";

//email ahora son amigos
$txt['nombre_del_smf_general'] = "Loemprendemos";
$txt['solicitud_conexion_subject2'] = "Loemprendemos: Conexion Exitosa";
$txt['solicitud_conexion6'] = "\n\n!Muchas Felicidades¡\n\nTu y ";
$txt['solicitud_conexion7'] = "ahora tienen una conexion y son amigos. \n\nEnvía un mensaje directo a éste usuario, y ¡Empecemos con los proyectos!.\n\n";
$txt['solicitud_conexion8'] = "Puedes Publicar en su muro o puedes enviar un Mensaje Directo a éste usuario directamente a través de ésta liga: ";
$txt['solicitud_conexion9'] = "o puedes ir a su perfil y dar click en Enviar Mensaje: ";
$txt['solicitud_conexion10'] = "\n\n";

//email like
$txt['solicitud_conexion_subject3'] = "Loemprendemos: Nuevo Me Gusta";
$txt['solicitud_conexion11'] = "te ha dado un me gusta a tu publicación: ";
$txt['solicitud_conexion12'] = "visita su perfil a través de la siguiente liga:";

//email publicar
$txt['solicitud_conexion_subject4'] = "Loemprendemos: Han Escrito en tu Muro";
$txt['solicitud_conexion13'] = "te ha Escrito en tu Muro.";
$txt['solicitud_conexion14'] = "visita tu perfil a través de la siguiente liga:";

//email custom form user to user
$txt['solicitud_conexion15'] = "\n\nMensaje Enviado desde http://loemprendemos.com";
$txt['solicitud_conexion16'] = "\n\nPuedes ver mi perfil en Loempredemos a través de: ";

//email list project
$txt['solicitud_conexion_subject5'] = "Loemprendemos: Te han Invitado a un Proyecto/Startup";
$txt['solicitud_conexion17'] = "¡Muchas Felicidades! te ha agregado ";
$txt['solicitud_conexion18'] = "socio/fundador";
$txt['solicitud_conexion19'] = "mentor/asesor";
$txt['solicitud_conexion20'] = "contribuidor o empleado";
$txt['solicitud_conexion21'] = "como";
$txt['solicitud_conexion22'] = "al proyecto/startup";
$txt['solicitud_conexion23'] = "puedes visualizar el proyecto/startup a través de la siguiente liga:";
$txt['solicitud_conexion24'] = "ha modificado el proyecto/startup";
$txt['solicitud_conexion25'] = "recuerda que sólo los fundadores o el creador del proyecto/startup pueden modificarlo.";
?>