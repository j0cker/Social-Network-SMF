...
<form class="flow_hidden" action="', $scripturl, '?action=pm;sa=pmactions;', $context['display_mode'] == 2 ? 'conversation;' : '', 'f=', $context['folder'], ';start=', $context['start'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', '" method="post" accept-charset="', $context['character_set'], '" name="pmFolder">';
	...
	if ($context['get_pmessage']('message', true))
	{
		...
		{ 
                   if($c==0){
                     echo '
                     <div style="border: 1px solid transparent; border-color: #bce8f1; background-color: #d9edf7; color: #31708f;" class="row text-center">
                       <div class="col-md-12 text-center">', $message['subject'], '</div>
                     </div>
                     ';
			...
			echo '
        '.($window_class=="windowbg2" ? '<div class="row"><div class="col-md-12"><div class="col-xs-2 col-md-2"></div>' : '<div class="row"><div class="col-md-12">').'
	<div style="'.($window_class=="windowbg" ? 'border: 1px solid transparent; border-color: #bce8f1; color: #31708f;' : 'border: 1px solid transparent; border-color: #faebcc; color: #8a6d3b; ' ).' border-radius: 20px;" class="', $window_class, ' col-xs-10 col-md-10">
		...
		<div class="row">';
			...
			<div class="row">
                          <div class="col-md-12">
                            <div class="posbit col-md-12">
                              <div style="'.($window_class=="windowbg" ? 'float: left;' : 'float: right;').'">
			        ...
			        echo '
			          <button onclick="googleAna('.$comillas.'MPProfile'.$comillas.');" type="button" class="btn btn-info btn-sm">', $message['member']['name'], '</button>
                                </a>
                                ', $message['time'], '
                              </div>
                            </div>';
		...
		<div class="postarea">
			...
			<div class="post">
				<div style="padding: 0; border-top: 0;" class="inner" id="msg_', $message['id'], '"', '>', $message['body'], '</div>';
        ...
        '.($window_class=="windowbg" ? '</div></div>' : '<div class="col-xs-2 col-md-2"></div></div></div>').' 
        ';
                $c++;
		}
