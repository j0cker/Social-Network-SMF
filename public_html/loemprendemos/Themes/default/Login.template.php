...
function template_login()
{
	...
	echo '
				<dl>
					...
					<dd><input onclick="googleAna('.$comillas.'guestTemplateLogCookies'.$comillas.');" type="text" name="cookielength" size="4" maxlength="4" value="', $modSettings['cookieTime'], '"', $context['never_expire'] ? ' disabled="disabled"' : '', ' class="input_text" /></dd>
	...
	echo '
				...
				<p><input onclick="googleAna('.$comillas.'guestTemplateLogLoginButton'.$comillas.');" type="submit" value="', $txt['login'], '" class="button_submit" /></p>
