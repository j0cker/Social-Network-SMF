...
function template_main()
{
  ...
  <table class="table table-bordered">
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
				<tr class="small">
					...
					<td class="subject ', $alternate_class, '">
						<div onclick="googleAna('.$comillas.'mainTopic'.$topic['new_href'].''.$comillas.'); window.location='.$comillas.'', $topic['new_href'], ''.$comillas.';" ', (!empty($topic['quick_mod']['modify']) ? 'id="topic_' . $topic['first_post']['id'] . '" onmouseout="mouse_on_div = 0;" onmouseover="mouse_on_div = 1;" ondblclick="modify_topic(\'' . $topic['id'] . '\', \'' . $topic['first_post']['id'] . '\');"' : ''), '>
			...
			echo '
							<p>', $txt['started_by'], ' ', $topic['first_post']['member']['name'], '
