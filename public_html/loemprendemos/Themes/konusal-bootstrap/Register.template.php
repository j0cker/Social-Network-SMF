...
function template_registration_agreement()
{
	...
	echo '
		...
		<br />
		<center>
			<input onclick="googleAna('.$comillas.'registerButtonAgreementtop'.$comillas.');" type="submit" name="accept_agreement" value="', $txt['agreement_agree'], '" class="btn btn-success text-center" style="margin-bottom: 20px;" /><br />
		</center>
	...
	if ($context['show_coppa'])
		...
		echo '
				<input onclick="googleAna('.$comillas.'registerButtonAgreementBottom'.$comillas.');" type="submit" name="accept_agreement" value="', $txt['agreement_agree'], '" class="btn btn-success" />';
...
function template_registration_form()
{
			...
			<div class="windowbg2">
				...
				<fieldset class="content">
					...
					<dl class="register_form">
							...
							<span id="smf_autov_username_div" style="display: none;">
								<a id="smf_autov_username_link" href="#">
									<img id="smf_autov_username_img" src="', $settings['images_url'], '/icons/field_check.gif" alt="*" />
                                                ...
                                                -->
						<dt><strong><label for="smf_autov_reserve1">', $txt['email'], ' ', $txt['allow_user_email2'], ':</label></strong></dt>
						<dd>
						...
						<dd>
							<input type="checkbox" name="allow_email" id="allow_email" tabindex="', $context['tabindex']++, '" class="input_check" hidden />
						</dd>
					</dl>';
	...
	{       foreach ($context['custom_fields'] as $field){
        ...
        // Are there any custom fields recommended from SMF?
