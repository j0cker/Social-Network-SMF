...
function template_generic_menu_dropdown_above()
{
   ...
   <div class="container-fluid">
      <div class="navbar-header">
         <button onclick="googleAna('.$comillas.'menuSMImgButtonProfile'.$comillas.');" type="button" class="navbar-toggle" data-toggle="collapse" data-target="#multi-level-dropdown">
