$(function() {
  ...
  //prueba
  //var appId = '11fffc68-7cac-4d64-81db-dff23f9138ee'; //loemprendemos
  //var scopes = 'openid profile User.Read Mail.Read Calendars.Read Contacts.Read';
  //var redirectUri = 'http://localhost:8080';

  //producción
  var appId = '00000000481EBE9C'; //loemprendemos
  var scopes = 'openid profile User.Read Contacts.Read';
  //var redirectUri = 'http://loemprendemos.com/index.php?action=welcome';
  var redirectUri = 'http://loemprendemos.com/outlookSDK/index.html';
