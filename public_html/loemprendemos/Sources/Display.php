...
function Display()
{
	...
	if (!empty($messages))
	{
		...
		$messages_request = $smcFunc['db_query']('', '
			SELECT id_msg, icon, subject, poster_time, poster_ip, id_member, modified_time, modified_name, body, smileys_enabled, poster_name, poster_email, approved, likes, likes_users, id_msg_modified < {int:new_from} AS is_read
			FROM {db_prefix}messages
...
function prepareDisplayContext($reset = false)
{
	...
	$output = array(
		...
		'body' => $message['body'],
                'likes' => $message['likes'],
                'likes_users' => $message['likes_users'],
