...
function registerMember(&$regOptions, $return_errors = false)
{
	...
	if ($smcFunc['strlen']($regOptions['username']) > 60)
	...
	if (empty($regOptions['email']) || filter_var($regOptions['email'], FILTER_VALIDATE_EMAIL) === false || strlen($regOptions['email']) > 255)
        ...
        // se busca si está reservado el nombre de usuario 
	...
	//insert themes variables like auto_notification, etc.
	...
	$inserts2 = array();
	$inserts2[] = array($memberID, 'show_board_desc', '1');
	...
	$inserts2 = array();
	$inserts2[] = array($memberID, 'return_to_post', '1');
	...
	$inserts2 = array();
	$inserts2[] = array($memberID, 'auto_notify', '1');
	...
	$inserts2 = array();
	$inserts2[] = array($memberID, 'display_quick_reply', '1');
